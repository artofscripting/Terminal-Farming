...
export const CROPS = [
  ...
  { id: 'berry',   name: 'Berry',   seasons: ['summer'],           daysWatered: 5, stages: 4, seedCost: 22, sellBase: 60, glyphGrow: 'y', glyphRipe: 'R', color: '#c03060', colorRipe: '#f04080' },
  ...
  { id: 'pepper',  name: 'Pepper',  seasons: ['summer'],           daysWatered: 4, stages: 4, seedCost: 20, sellBase: 55, glyphGrow: 'e', glyphRipe: 'E', color: '#d03030', colorRipe: '#f04040' },
  { id: 'cucumber', name: 'Cucumber', seasons: ['summer'],         daysWatered: 4, stages: 4, seedCost: 16, sellBase: 42, glyphGrow: 'q', glyphRipe: 'Q', color: '#4aa040', colorRipe: '#6ac060' },
  ...
  { id: 'eggplant', name: 'Eggplant', seasons: ['fall'],           daysWatered: 5, stages: 5, seedCost: 20, sellBase: 58, glyphGrow: 'g', glyphRipe: 'G', color: '#7050a0', colorRipe: '#9070c0', minFarmingLevel: 2 },
