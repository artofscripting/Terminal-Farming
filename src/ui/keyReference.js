...
export const KEY_MEANINGS = {
  ...
  S: [['Game', 'Open the lifetime Stats & Achievements panel'], ['Stats', 'Close the Stats panel'], ['Shop', 'Buy the Seed Plant (450g)']],
  ...
  F: [['Game (tractor mounted)', "Run the current implement over every tile in the plot you're standing in (fuel + 1/10th energy per tile)"]],
  ...
  i: [['Game', 'Open the inventory'], ['Inventory', 'Close the inventory'], ['Load menu', 'Import a save from a file']],
  ...
  enter: [['Pause menu', 'Resume'], ['Command console', 'Run the typed command'], ['Custom game setup', 'Start game with current settings']],
  backspace: [['Command console', 'Delete the last typed character']],
  '1': [['Title screen', 'New game'], ['Pause menu', 'Resume'], ['Save / Load menu', 'Slot 1'], ['Shop', 'Buy seeds'], ['Town', 'Talk to the 1st townsfolk listed'], ['Custom game setup', 'Cycle starting gold']],
  '2': [['Title screen', 'Load game'], ['Pause menu', 'Save game'], ['Save / Load menu', 'Slot 2'], ['Shop', 'Sell items'], ['Town', 'Talk to the 2nd townsfolk listed'], ['Custom game setup', 'Cycle starting plots']],
  '3': [['Title screen', 'Custom game'], ['Pause menu', 'Load game'], ['Save / Load menu', 'Slot 3'], ['Shop', 'Upgrade tools'], ['Town', 'Talk to the 3rd townsfolk listed'], ['Custom game setup', 'Cycle starting season']],
